...
public class Renderer {
	...
	public Renderer(Shader shader, Window window, String shader_version) {
		this.shader = shader;
		this.colorShader   = new Shader("ressources/shaders"+shader_version+"/color_mesh_vertex.glsl", "ressources/shaders"+shader_version+"/color_mesh_fragment.glsl", window);
		this.textureShader = new Shader("ressources/shaders"+shader_version+"/texture_mesh_vertex.glsl", "ressources/shaders"+shader_version+"/texture_mesh_fragment.glsl", window);
		this.gui_shader    = new Shader("ressources/shaders"+shader_version+"/gui_mesh_vertex.glsl", "ressources/shaders"+shader_version+"/gui_mesh_fragment.glsl", window);
		this.window = window;
	}
